...
export default function Belief() {
  return (
    <>
    {/* <section className="bg-green-50 w-full mt-24 py-10 sm:py-24">
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-2 gap-14">
        <Image
          ...
          height={0}
        />
      <div className="flex flex-col justify-center lg:mx-0 mx-8">
...
<section className="overflow-hidden bg-green-50 mt-24 py-10 sm:py-24">
