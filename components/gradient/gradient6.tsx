...
export default function gradient6() {
  return (
    ...
    <svg
      className="relative left-[calc(50%-11rem)] -z-10 h-[90.1875rem] max-w-none -translate-x-1/2 rotate-[0deg] sm:left-[calc(30%-30rem)] sm:h-[75.375rem] lg:mt-[2000px] md:mt-[2490px] mt-[3200px]"
