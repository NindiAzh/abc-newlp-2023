...
<div className="absolute -inset-x-0 -top-0 -z-10 transform-gpu overflow-hidden blur-[50px] sm:-top-20">
  <svg className="relative left-[calc(50%-11rem)] -z-10 h-[90.1875rem] max-w-none -translate-x-1/2 rotate-[0deg] sm:left-[calc(40%-30rem)] sm:h-[75.375rem] lg:mt-[2200px] md:mt-[3600px] mt-[4180px]" viewBox="0 0 1155 678">
