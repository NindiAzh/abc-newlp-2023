...
<div className="absolute -inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-[50px] sm:-top-20">
    <svg className="relative left-[calc(50%-11rem)] -z-10 h-[90.1875rem] max-w-none -translate-x-1/2 rotate-[0deg] sm:left-[calc(30%-30rem)] sm:h-[75.375rem] lg:mt-[1500px] md:mt-[2490px] mt-[2400px]" viewBox="0 0 1155 678">
  ...
  <div className="absolute -inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-[50px] sm:-top-20">
    <svg className="relative left-[calc(50%-11rem)] -z-10 h-[90.1875rem] max-w-none -translate-x-1/2 rotate-[0deg] sm:left-[calc(70%-30rem)] sm:h-[70.375rem] lg:mt-[1450px] md:mt-[2350px] mt-[2100px]" viewBox="0 0 1155 678">
      <path d="M106 109L1533.5 950.5" stroke="url(#paint0_linear_1354_93351)" strokeOpacity="0.5" strokeWidth={20} />
      <defs>
        <linearGradient id="paint0_linear_1354_93351" x1="819.75" y1={109} x2="819.75" y2="950.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1DC0AD" />
